...
import { assertDisposableTestDatabaseUrl } from './helpers/disposable-postgres.mjs';
...
test('integration command only reads TEST_DATABASE_URL', async () => {
  const source = await readFile(new URL('../scripts/test-integration.mjs', import.meta.url), 'utf8');
