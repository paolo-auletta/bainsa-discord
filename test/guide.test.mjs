...
import { buildGuideAccess, guideScopeLabel } from '../src/guide/access.mjs';
import { GUIDE_CATALOG, GUIDE_COMMAND_NAMES } from '../src/guide/catalog.mjs';
import {
  guideInteractions,
  homePayload,
  parseCustomId,
