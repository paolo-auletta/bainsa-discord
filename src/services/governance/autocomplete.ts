...
import { getUniversityByName } from './repository.js';
...
export async function warmGovernanceAutocompleteCache(deps: GovernanceDependencies = {}) {
...
export async function findUniversities(term = '', deps: GovernanceDependencies = {}) {
