...
import { replyEphemeral } from '../discord/reply.mjs';
import { UserFacingError } from '../errors.mjs';
import { botCommandChannelScope } from '../runtime/command-channels.mjs';
import { buildGuideAccess, guideScopeLabel } from './access.mjs';
import { GUIDE_CATALOG, GUIDE_TOPICS, guideEntry } from './catalog.mjs';
